...
const HARD_CODED_CONTRACT_ADDRESS = "0x8C370093043E6BB4cBcA31a15a2A4A0C0dCC0143"; // Replace with your contract address
...
const AIAgentRegistry: React.FC = () => {
