...
const HARD_CODED_CONTRACT_ADDRESS = "0x9e6CB9dd6B64b1b7D06cb3b2883601bd02daeD8d"; // Replace with your contract address
const HARD_CODED_ABI = `[
  ...
  {
    "inputs": [],
    "name": "CoincapsuleContract",
    "outputs": [
      {
        "internalType": "contract ICoincapsule",
        "name": "",
        "type": "address"
      }
    ],
...
const CapsuleAIAgentRegistry: React.FC = () => {
   ...
   return (
    <div style={{
      ...
      <h2 style={{ fontSize: "26px", fontWeight: "bold", marginBottom: "16px", textAlign: "center" }}>
        Iconoclast Capsule AI Agent Registry
      </h2>
...
export default CapsuleAIAgentRegistry;
;