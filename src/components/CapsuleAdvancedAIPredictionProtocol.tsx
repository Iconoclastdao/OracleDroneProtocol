...
const HARD_CODED_CONTRACT_ADDRESS = "0xE47A2BdFE614C5e7Bba981424bABf7E9b39fA4A4"; // Replace with your contract address
...
const CapsuleAdvancedAIPredictionProtocol: React.FC = () => {
   ...
   return (
    <div style={{
      ...
      <h2 style={{ fontSize: "26px", fontWeight: "bold", marginBottom: "16px", textAlign: "center" }}>
        Iconoclast Capsule Advanced AI Prediction Protocol
      </h2>
...
export default CapsuleAdvancedAIPredictionProtocol;