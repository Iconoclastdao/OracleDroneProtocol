...
const HARD_CODED_CONTRACT_ADDRESS = "0xc63D24925bA82767f7862c5Bd0fDC57B92591D4A"; // Replace with your contract address
const HARD_CODED_ABI = `[
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract CapsuleAIAgentRegistry",
        "name": "",
        "type": "address"
      }
    ],
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract CapsuleAdvancedAIPredictionProtocol",
        "name": "",
        "type": "address"
      }
    ],
...
const CapsuleCognitiveOracle : React.FC = () => {
   ...
   return (
    <div style={{
      ...
      <h2 style={{ fontSize: "26px", fontWeight: "bold", marginBottom: "16px", textAlign: "center" }}>
        Iconoclast Capsule Cognitive Oracle 
      </h2>
...
export default CapsuleCognitiveOracle ;